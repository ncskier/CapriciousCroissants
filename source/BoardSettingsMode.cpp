...
bool BoardSettingsMode::init(const std::shared_ptr<cugl::AssetManager>& assets) {
	...
	int appHeight = Application::get()->getDisplayHeight();
	int scale = SCENE_WIDTH / dimen.width;
	...
	_upHeightButton->setPosition(position.set(734, 576 - 93).scale(scale));
	...
	_downHeightButton->setPosition(position.set(734, 576 - 125).scale(scale));
	...
	_upWidthButton->setPosition(position.set(734, 576 - 168).scale(scale));
	...
	_downWidthButton->setPosition(position.set(734, 576 - 200).scale(scale));
	...
	_upColorsButton->setPosition(position.set(734, 576 - 285).scale(scale));
	...
	_downColorsButton->setPosition(position.set(734, 576 - 316).scale(scale));
	...
	_upAlliesButton->setPosition(position.set(734, 576 - 358).scale(scale));
	...
	_downAlliesButton->setPosition(position.set(734, 576 - 390).scale(scale));
	...
	_placePawnsButton->setPosition(position.set(590, 576 - 512).scale(scale));
	...
	_doneButton->setPosition(position.set(835, 576 - 561).scale(scale));
